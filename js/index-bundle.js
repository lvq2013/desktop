...
/*let Global = {
    "oVideoWrap":$(".video-wrap"),
    // "oLi":$(".list-box .list .item"),
    "i": 0
};*/
...
function setNowTime() {
    setInterval(function () {
        var d = new Date();
        var now_date = d.toLocaleDateString();
...
function login() {
    $("#btn").click(function () {
        ...
        if (user === "" && psw === "") {
            $(".front-box").animate({ "top": "-100vh" }, 1000);
            $(".video-wrap").animate({ "top": "0" }, 1000);
            rightMouse();
            iconMove();
        }
    });
...
function rightMouse() {
    ...
    document.onselectstart = new Function("event.returnValue=false;"); //禁止被选中

    var oRightBox = $(".item-menu");
    ...
    $(document).on({
        "mousedown": function mousedown(e) {
            if (e.button === 2) {
                ...
                oRightBox.css({ "left": left, "top": top });
                ...
                $("#nextBG").click(function () {
                    ...
                    $(".video-wrap").css("background", 'url("../images/bg/bg_0"+ i +".jpg")');
                });
            }
            if (e.button === 0) {
...
function iconMove() {
        ...
        $li.mousedown(function (e) {
            ...
            $(document).mouseup(function (e) {
                ...
                $se.each(function (i) {
                    ...
                    x[i] = Math.round(($(this).offset().left - 20) / (liW + 40));
                });
    ...
    (function () {
        ...
        function pz($1, $2) {
            var t1 = $1.offset().top;
            var b1 = t1 + $1.outerHeight();
            var l1 = $1.offset().left;
            var r1 = l1 + $1.outerWidth();
            var t2 = $2.offset().top;
            var b2 = t2 + $2.outerHeight();
            var l2 = $2.offset().left;
            var r2 = l2 + $2.outerWidth();
            return b1 < t2 || l1 > r2 || t1 > b2 || r1 < l2 ? 0 : 1;
        };
    })();
}
